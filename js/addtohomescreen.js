...
ath.defaults = {
	...
	fontSize: 10,				// base font size, used to properly resize the popup based on viewport scale factor // def 15
	...
	startDelay: 30,				// display the message after that many seconds from page load
	lifespan: 15,				// life of the message in seconds
	displayPace: 1440,			// minutes before the message is shown again (0: display every time, default 24 hours) default 1440
